...
public class Driver {
	...
	public static void populateBST() {
		System.out.println("After you have entered all entries of the data set enter -1");
	...
	public static void DLLSwitchCase() {
		...
		private static void empiricalStudy() {
			...
			System.out.println("Average time taken by DLL: " + BSTTimeSum);
			System.out.println("Average time taken by BST: " + DLLTimeSum);
		...
		public static void main(String... args) {
			System.out.println("Choose thing following option.  1: BST 2: DLL 3:Int20kFile for BST and DLL" );
			Scanner in = new Scanner(System.in);
			int option = in.nextInt();
			switch(option) {
			case 1:
